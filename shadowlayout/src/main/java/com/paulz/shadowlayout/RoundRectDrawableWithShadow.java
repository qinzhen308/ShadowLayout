...
public class RoundRectDrawableWithShadow extends Drawable {
    ...
    private static final float SHADOW_MULTIPLIER = 1;
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius,int shadowStartColor, int shadowEndColor,
